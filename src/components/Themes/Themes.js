  ...
  return (
    <div className="container">
      ...
      <div className="cards-grid grid grid-cols-1 gap-4 place-items-center md:grid md:grid-cols-2 md:gap-4 xl:grid xl:grid-cols-4 xl:gap-8">
        ...
        >
          <h1 style={{ filter: !hover ? "none" : "blur(8px)", color: hover && "#867dbb" }}>Social Welfare</h1>
          <img
            src={hoBlue}
            alt="default.png"
          ...
          >
            ...
            challenges, promoting well-being and tackling poverty, healthcare, and
            education. Let's work together to make a positive impact on society.
          </p>
        </motion.div>
        ...
        >
          <h1 style={{ filter: !hover1 ? "none" : "blur(8px)", color: hover1 && "#80ffea" }}>Fintech</h1>
          <img
            src={hoGreen}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover1 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover2 ? "none" : "blur(8px)", color: hover2 && "#ffff80" }}>Open Source</h1>
          <img
            src={hoYellow}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover2 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover3 ? "none" : "blur(8px)", color: hover3 && "#a9519f" }}>Healthcare</h1>
          <img
            src={hoPurple}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover3 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover4 ? "none" : "blur(8px)", color: hover4 && "#867dbb" }}>AI/ML</h1>
          <img
            src={hoBlue}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover4 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover5 ? "none" : "blur(8px)", color: hover5 && "#ffff80" }}>AR/VR</h1>
          <img
            src={hoYellow}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover5 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover6 ? "none" : "blur(8px)", color: hover6 && "#80ffea" }}>Blockchain</h1>
          <img
            src={hoGreen}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover6 ? "none" : "block" }}
          >
        ...
        >
          <h1 style={{ filter: !hover7 ? "none" : "blur(8px)", color: hover7 && "#ffff80" }}>Sustainablity</h1>
          <img
            src={hoYellow}
            alt="default.png"
          ...
          />
          <p
            style={{ display: !hover7 ? "none" : "block" }}
          >
