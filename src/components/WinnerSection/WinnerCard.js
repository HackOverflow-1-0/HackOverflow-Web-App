...
export default function WinnerCard() {
  return (
    <div className="flex items-center my-3 bg-white rounded-lg shadow border border-gray-300  cursor-pointer">
      ...
      <div className="text-sm flex-grow">
        <p className="text-gray-900 leading-none font-semibold">winner</p>
...
// hover:border-pink-300 hover:bg-pink-200
