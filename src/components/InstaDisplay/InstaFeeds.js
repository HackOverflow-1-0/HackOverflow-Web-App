    ...
    return (
        <>
            <div className='InstaSvg pt-8 pb-2 flex flex-row justify-center items-center space-x-4'>
                ...
                <div>
                    <h2 className='text-[1.3rem] md:text-[2rem] mb-0'>Follow us on <a className='InstaLink' href='https://phcet.tech/insta' target="_blank" rel="noreferrer">@hackoverflow.tech</a></h2>
                </div>
            </div>
