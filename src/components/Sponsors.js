    ...
    return (
        <section className="project" id="project">
            <Container>
                ...
                <div class="absolute h-[2px] bg-[#7b1072] w-56"></div>
                    <h1 className="text-[2.5rem] tracking-[.05em] sm:text-[2rem] md:text-[3rem] lg:text-[4rem] capitalize">
                    OUR SPONSORS
                    </h1>
                </div>
                ...
                <TitleSponsorsCard image={hack2skill} dataAos="fade-up" />
                ...
                <div className="grid grid-cols-1 gap-2 md:grid md:grid-cols-2 md:gap-3">
                    <MediumSponsorsCard title="EVENT PARTNER" image={hack2skill} dataAos="fade-right" />
                    <MediumSponsorsCard title="ASSOCIATE SPONSOR" image={hack2skill} dataAos="fade-left" />
                    <MediumSponsorsCard title="UPSKILLING PARTNER" image={hack2skill} dataAos="fade-right" />
                    <MediumSponsorsCard title="SILVER SPONSORS" image={hack2skill} dataAos="fade-left" />
                </div>
                <div className="pt-10">
                    <hr className="text-[#767676] dark:text-[#767676]" />
                </div>
